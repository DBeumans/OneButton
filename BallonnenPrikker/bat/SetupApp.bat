...
:: Android packaging
set AND_CERT_NAME="Ballonnen Prikker"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\BallonnenPrikker.p12
...
set IOS_PROVISION=cert\BallonnenPrikker.mobileprovision
...
:: Output packages
set DIST_PATH=dist
set DIST_NAME=BallonnenPrikker
